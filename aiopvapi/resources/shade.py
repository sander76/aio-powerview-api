...
class ShadeBottomUp(BaseShade):
    ...
    capabilities = (
        capability(0, "Primary", "Bottom Up"),
    )
...
class ShadeBottomUpTilt(ShadeTiltBase):
    ...
    capabilities = (
        capability(0, "Primary + TiltOnClosed + Tilt180",
                   "Bottom Up Tilt 180°"),
    )
...
class ShadeBottomUpTilt90(ShadeBottomUpTilt):
    ...
    capabilities = (
        capability(1, "Primary + TiltOnClosed + Tilt90", "Bottom Up Tilt 90°"),
    )
...
class ShadeBottomUpTiltAnywhere(ShadeTiltBase):
    ...
    capabilities = (
        capability(2, "Primary + TiltAnywhere + Tilt180",
                   "Bottom Up Tilt 180°"),
    )
...
class ShadeVerticalTilt(ShadeBottomUpTilt):
    ...
    capabilities = (
        capability(3, "Primary + TiltOnClosed + Tilt180", "Vertical"),
    )
...
class ShadeVerticalTiltAnywhere(ShadeBottomUpTiltAnywhere):
    ...
    capabilities = (
        capability(4, "Primary + TiltAnywhere + Tilt180",
                   "Vertical Tilt 180°"),
    )
...
class ShadeTopDown(BaseShade):
    ...
    capabilities = (
        capability(6, "Primary + PrimaryInverted", "Top Down"),
    )
...
class ShadeTdbu(BaseShade):
    ...
    capabilities = (
        capability(7, "Primary + Secondary + TopDown", "Top Down Bottom Up"),
    )
...
class ShadeDualInterlocked(BaseShade):
    ...
    capabilities = (
        capability(8, "Primary + SecondaryInterlocked",
...
class ShadeDualInterlockedTilt(ShadeTiltBase):
    ...
    capabilities = (
        capability(9, "Primary + TiltOnRearClosed + SecondaryInterlocked",
                   "Dual Shade Interlocked Tilt 90°"),
    )
